...
public class Order implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(driver, other.driver) && Objects.equals(orderTime, other.orderTime)
        ...
        && Double.doubleToLongBits(totalTime) == Double.doubleToLongBits(other.totalTime) && Double
            .doubleToLongBits(totalWaitingTime) == Double.doubleToLongBits(other.totalWaitingTime)
